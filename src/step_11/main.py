"""Step 11 — Cavity Flow (2D Navier–Stokes)

Source notebook: lessons/14_Step_11.ipynb
...
# (notebook cell 20 skipped — IPython-only: 'import numpy')
...
# (notebook cell 38 skipped — IPython-only: 'from IPython.core.display import HTML')


def main() -> None:
    """Run the Step 11 — Cavity Flow (2D Navier–Stokes) example end-to-end."""
